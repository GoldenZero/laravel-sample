...
<head>
    ...
    <link rel="stylesheet"
          href="//cdn.jsdelivr.net/g/prism@1.3.0(themes/prism.css+themes/prism-okaidia.css+plugins/show-language/prism-show-language.css+plugins/line-numbers/prism-line-numbers.css)">
    <link href='//fonts.googleapis.com/css?family=Roboto:500,400' rel='stylesheet' type='text/css'>
    <link href="{!! asset('css/md-data-table.min.css') !!}" rel="stylesheet" type="text/css"/>
...
<md-sidenav
    ...
    <md-toolbar class="Sidebar-header">
        <h1 class="md-toolbar-tools Sidebar-title">Admin Panel</h1>
    </md-toolbar>
...
<script type="text/javascript" src="{!! asset('js/md-data-table.min.js') !!}"></script>
